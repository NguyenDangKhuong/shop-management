...
const BOTTOM_PROMPTS = [
    {
        ...
        order: 7,
        subPrompt: SUB_PROMPT,
        content: `A highly detailed cinematic fashion video of the model shown in reference image 2. ${BOTTOM_COVERAGE} ${BOTTOM_DETAILS} She has luminous snow-white porcelain skin, Douyin goddess aesthetic, long silky black hair with soft natural waves, wearing stylish feminine thin gold-framed round glasses. ${BODY_INTEGRITY} She is standing [POSE] in front of a full-length mirror in a [BACKGROUND]. Soft golden morning sunlight streaming through sheer white curtains creating warm natural light and gentle shadows. ${SLOW_MOTION} She is holding an orange iPhone 17 Pro Max up in front of her face covering her face completely while recording a mirror selfie video so only the phone and the outfit are visible not her face. The phone camera angle moves naturally to frame the garment showing the waist fit the fabric drape the silhouette and the hem length then slowly tilts down to show the full length of the pants or skirt then pulls back to reveal the full outfit styling. She speaks naturally in Vietnamese describing the garment she is wearing focusing on the fit the fabric quality the waist design and the overall silhouette with a warm friendly tone like a real fashion KOL on livestream. No text no captions no animals. Ultra-realistic natural handheld phone movement. Shallow depth of field with outfit in sharp focus. Fashion editorial cinematic color grading`
    },
    {
        ...
        order: 8,
        subPrompt: SUB_PROMPT,
        content: `A highly detailed cinematic fashion video of the model shown in reference image 2. ${BOTTOM_COVERAGE} ${BOTTOM_DETAILS} She has luminous snow-white porcelain skin, Douyin goddess aesthetic, long silky black hair with soft natural waves, wearing stylish feminine thin gold-framed round glasses. ${BODY_INTEGRITY} She is standing [POSE] in front of a full-length mirror in a [BACKGROUND]. Soft golden morning sunlight streaming through sheer white curtains creating warm natural light. ${SLOW_MOTION} She is holding an orange iPhone 17 Pro Max up in front of her face covering her face completely while recording herself so only the phone and the garment are visible not her face. Her free hand gently touches the fabric showing the smooth quality material then slides along the garment to show the fit and drape. She pinches the fabric slightly highlighting the softness and texture then moves her hand to the waistband showing the fit and closure details. She speaks naturally in Vietnamese without greeting or saying hello just directly describing the fabric quality the waist fit and how the garment drapes with a confident casual tone. No text no captions no animals. Ultra-realistic natural handheld phone movement. Shallow depth of field. Fashion editorial cinematic color grading`
    },
    {
        ...
        order: 9,
        subPrompt: SUB_PROMPT,
        content: `A highly detailed cinematic fashion video of the model shown in reference image 2. ${BOTTOM_COVERAGE} ${BOTTOM_DETAILS} She has luminous snow-white porcelain skin, Douyin goddess aesthetic, long silky black hair with soft natural waves, wearing stylish feminine thin gold-framed round glasses. ${BODY_INTEGRITY} She is standing [POSE] in front of a full-length mirror in a [BACKGROUND]. Soft golden morning sunlight streaming through sheer white curtains creating warm natural light and gentle shadows. ${SLOW_MOTION} She is holding an orange iPhone 17 Pro Max up in front of her face covering her face completely while recording so only the phone and the outfit are visible not her face. She subtly shifts her weight and turns gently to the left showing the garment from a slight side angle revealing the side seam and fabric flow then back to center then gently to the right showing the back silhouette of the garment. Her free hand rests naturally then moves to smooth the fabric along the waistband. She speaks naturally in Vietnamese without greeting or saying hello just casually commenting on the garment fit the fabric quality and how it looks from different angles with a sweet relaxed voice. No text no captions no animals. Ultra-realistic natural handheld phone movement. Shallow depth of field with outfit in sharp focus. Fashion editorial cinematic color grading`
    }
]
