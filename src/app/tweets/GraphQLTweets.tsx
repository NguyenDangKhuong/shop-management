...
function TweetCard({ tweet, videoProxyUrl }: { tweet: TweetData; videoProxyUrl: string }) {
    return (
            ...
            <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1 text-sm">
                        ...
                        <span className="text-slate-500 truncate">@{tweet.user.screenName}</span>
                        ...
                        <div className="mt-3 border border-white/10 rounded-2xl overflow-hidden">
                            <div className="px-3 py-2">
                                <div className="flex items-center gap-1.5 text-sm">
                                    ...
                                    <span className="text-slate-500 text-xs">@{tweet.quotedTweet.user.screenName}</span>
                                </div>
...
export function GraphQLTweets({ username }: GraphQLTweetsProps) {
    ...
    return (
        <div className="bg-slate-900/40 rounded-2xl border border-white/10 overflow-hidden">
            ...
            {/* Tweets */}
            {tweets.map(tweet => (
                <TweetCard key={tweet.id} tweet={tweet} videoProxyUrl={videoProxyUrl} />
            ))}
