        ...
        <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
            <div className="max-w-4xl mx-auto bg-white dark:bg-slate-900/80 rounded-lg shadow-md dark:shadow-slate-900/50 p-8 dark:border dark:border-white/10">
                ...
                <div className="prose prose-gray max-w-none space-y-6">
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-200 mb-4">1. Introduction</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-200 mb-4">2. Information We Collect</h2>

                        <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3 mt-4">2.1 Personal Information</h3>
                        ...
                        <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3 mt-4">2.2 TikTok Integration Data</h3>
                        <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-3">
                        ...
                        <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3 mt-4">2.3 Automatically Collected Information</h3>
                        <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-3">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-200 mb-4">3. How We Use Your Information</h2>
                        <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-3">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-200 mb-4">4. How We Share Your Information</h2>
                        <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-3">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-200 mb-4">5. TikTok Data Usage and Permissions</h2>
                        <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-3">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-200 mb-4">6. Data Security</h2>
                        <p className="text-gray-700 dark:text-slate-300 leading-relaxed">
                            We implement appropriate technical and organizational security measures to protect your personal
                            information against unauthorized access, alteration, disclosure, or destruction. These measures include:
                        </p>
                        <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-slate-300 mt-3">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-200 mb-4">7. Data Retention</h2>
                        <p className="text-gray-700 dark:text-slate-300 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-200 mb-4">8. Your Privacy Rights</h2>
                        <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-3">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-200 mb-4">9. Cookies and Tracking Technologies</h2>
                        <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-3">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-200 mb-4">10. Third-Party Services</h2>
                        <p className="text-gray-700 dark:text-slate-300 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-200 mb-4">11. Children&apos;s Privacy</h2>
                        <p className="text-gray-700 dark:text-slate-300 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-200 mb-4">12. International Data Transfers</h2>
                        <p className="text-gray-700 dark:text-slate-300 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-200 mb-4">13. Changes to This Privacy Policy</h2>
                        <p className="text-gray-700 dark:text-slate-300 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-800 dark:text-slate-200 mb-4">14. Contact Us</h2>
                        <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-3">
