...
new TextEncoder().encode('Việt').length // 6 bytes`}</CodeBlock>
            ...
            <TopicModal title="Process vs Thread" emoji="⚙️" color="#ef4444" summary="Hiểu OS quản lý chương trình — tại sao Node.js single-threaded mà vẫn nhanh">
                ...
                <div className="my-3 overflow-x-auto">
                    <table className="w-full text-sm border-collapse">
                        <thead><tr className="border-b border-white/10"><th className="text-left p-2 text-slate-400">Tiêu chí</th><th className="text-left p-2 text-blue-400">Process</th><th className="text-left p-2 text-green-400">Thread</th></tr></thead>
                        <tbody className="text-slate-300">
                            <tr className="border-b border-white/5"><td className="p-2">Memory</td><td className="p-2">Riêng biệt</td><td className="p-2">Chia sẻ với process</td></tr>
                            <tr className="border-b border-white/5"><td className="p-2">Tạo mới</td><td className="p-2">Nặng (~MB)</td><td className="p-2">Nhẹ (~KB)</td></tr>
                            <tr className="border-b border-white/5"><td className="p-2">Crash</td><td className="p-2">Không ảnh hưởng process khác</td><td className="p-2">Có thể crash cả process</td></tr>
        ...
        <div className="my-4 space-y-2">
            ...
            <TopicModal title="REST vs GraphQL" emoji="🔌" color="#ef4444" summary="Hai mô hình API phổ biến — khi nào dùng cái nào">
                <div className="my-3 overflow-x-auto">
                    <table className="w-full text-sm border-collapse">
                        <thead><tr className="border-b border-white/10"><th className="text-left p-2 text-slate-400">Tiêu chí</th><th className="text-left p-2 text-blue-400">REST</th><th className="text-left p-2 text-purple-400">GraphQL</th></tr></thead>
                        <tbody className="text-slate-300">
                            <tr className="border-b border-white/5"><td className="p-2">Kiểu</td><td className="p-2">Nhiều endpoints</td><td className="p-2">1 endpoint duy nhất</td></tr>
                            <tr className="border-b border-white/5"><td className="p-2">Data fetching</td><td className="p-2">Server quyết định trả gì</td><td className="p-2">Client chọn fields cần</td></tr>
                            <tr className="border-b border-white/5"><td className="p-2">Over-fetching</td><td className="p-2">Thường xảy ra</td><td className="p-2">Không bao giờ</td></tr>
                            <tr className="border-b border-white/5"><td className="p-2">Caching</td><td className="p-2">HTTP caching đơn giản</td><td className="p-2">Phức tạp hơn</td></tr>
...
→ { name: "An", email: "..." } // Không thừa data!`}</CodeBlock>
            ...
            <TopicModal title="CORS, Cookies, JWT" emoji="🔐" color="#ef4444" summary="Authentication flow — cách web apps xác thực người dùng">
                ...
                <div className="my-3 overflow-x-auto">
                    <table className="w-full text-sm border-collapse">
                        <thead><tr className="border-b border-white/10"><th className="text-left p-2 text-slate-400">Tiêu chí</th><th className="text-left p-2 text-blue-400">Cookie</th><th className="text-left p-2 text-green-400">JWT</th></tr></thead>
                        <tbody className="text-slate-300">
                            <tr className="border-b border-white/5"><td className="p-2">Lưu ở</td><td className="p-2">Browser (tự gửi)</td><td className="p-2">Client (localStorage/memory)</td></tr>
                            <tr className="border-b border-white/5"><td className="p-2">Stateful</td><td className="p-2">Server lưu session</td><td className="p-2">Stateless — token chứa data</td></tr>
                            <tr className="border-b border-white/5"><td className="p-2">XSS risk</td><td className="p-2">httpOnly flag bảo vệ</td><td className="p-2">Nếu ở localStorage — risk!</td></tr>
...
// count KHÔNG truy cập trực tiếp được!`}</CodeBlock>
            ...
            <TopicModal title="this keyword" emoji="👉" color="#f472b6" summary="4 rules binding: default, implicit, explicit, new">
                ...
                <div className="my-3 overflow-x-auto">
                    <table className="w-full text-sm border-collapse">
                        <thead><tr className="border-b border-white/10"><th className="text-left p-2 text-slate-400">Rule</th><th className="text-left p-2 text-slate-400">this =</th><th className="text-left p-2 text-slate-400">Ví dụ</th></tr></thead>
                        <tbody className="text-slate-300">
                            ...
                            <tr className="border-b border-white/5"><td className="p-2 text-blue-400">Implicit</td><td className="p-2">object trước dấu .</td><td className="p-2"><InlineCode>obj.foo()</InlineCode></td></tr>
                            <tr className="border-b border-white/5"><td className="p-2 text-green-400">Explicit</td><td className="p-2">argument đầu</td><td className="p-2"><InlineCode>foo.call(obj)</InlineCode></td></tr>
...
.responsive {
    ...
    grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));
            ...
            <TopicModal title="Core Web Vitals" emoji="📊" color="#38bdf8" summary="LCP, FID, CLS — Google đo performance thế nào, cách tối ưu">
                <div className="my-3 overflow-x-auto">
                    <table className="w-full text-sm border-collapse">
                        <thead><tr className="border-b border-white/10"><th className="text-left p-2 text-slate-400">Metric</th><th className="text-left p-2 text-slate-400">Đo gì</th><th className="text-left p-2 text-green-400">Good</th><th className="text-left p-2 text-slate-400">Cách tối ưu</th></tr></thead>
                        <tbody className="text-slate-300">
            ...
            <table className="w-full text-sm border-collapse">
                <thead>
                    <tr className="border-b border-white/10">
                        ...
                        <th className="text-left p-3 text-slate-400 font-medium">Mức độ</th>
        ...
        <div className="my-6 overflow-x-auto">
            <table className="w-full text-sm border-collapse">
                <thead>
                    <tr className="border-b border-white/10">
                        <th className="text-left p-3 text-slate-400 font-medium">Tháng</th>
        ...
        <div className="my-6 space-y-3">
            <div className="flex items-start gap-3 p-3 rounded-lg bg-slate-800/40 border border-white/5">
                ...
                <span className="text-slate-300"><Highlight>Nền tảng CS</Highlight> — đừng skip, đây là thứ phân biệt junior và senior</span>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-slate-800/40 border border-white/5">
                <span className="text-yellow-400 mt-0.5">2.</span>
                <span className="text-slate-300"><Highlight>JS sâu</Highlight> — hiểu cơ chế, không chỉ syntax. Implement từ scratch</span>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-slate-800/40 border border-white/5">
                <span className="text-blue-400 mt-0.5">3.</span>
                <span className="text-slate-300"><Highlight>React + FE</Highlight> — build UI thuần, hiểu rendering, performance</span>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-slate-800/40 border border-white/5">
                <span className="text-green-400 mt-0.5">4.</span>
                <span className="text-slate-300"><Highlight>DSA</Highlight> — 150 bài LeetCode, focus patterns không phải số lượng</span>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-slate-800/40 border border-white/5">
                <span className="text-purple-400 mt-0.5">5.</span>
                <span className="text-slate-300"><Highlight>System Design</Highlight> — thiết kế FE architecture, không chỉ vẽ diagram</span>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-slate-800/40 border border-white/5">
                <span className="text-pink-400 mt-0.5">6.</span>
                <span className="text-slate-300"><Highlight>Mock + Behavioral</Highlight> — practice nói to, chuẩn bị câu chuyện STAR</span>
            </div>
        </div>
...
const enContent = (
    <>
        <Paragraph>
            Want to join <Highlight>Google, Meta, Amazon, Apple, Microsoft</Highlight> (FAANG) or other big tech
            as a <Highlight>Frontend Engineer</Highlight>? This article is a detailed A-Z roadmap —
            especially for those who feel their <Highlight>programming fundamentals are weak</Highlight> and want to rebuild from scratch.
        </Paragraph>

        <Callout type="info">
            This roadmap is divided into <Highlight>6 phases</Highlight>, each about 4-6 weeks.
            Total: <Highlight>6-9 months</Highlight> with serious study of 2-3 hours daily.
        </Callout>
        ...
        <div className="my-6 p-4 rounded-xl bg-slate-800/50 border border-white/10">
            <div className="flex flex-col items-center gap-2 text-sm">
                ...
                <div className="text-slate-600">↓</div>
                <div className="px-4 py-2 rounded-lg bg-yellow-500/20 text-yellow-300 border border-yellow-500/30 w-fit font-semibold">Phase 2 — JavaScript Mastery (4-6 weeks)</div>
                <div className="text-slate-600">↓</div>
                <div className="px-4 py-2 rounded-lg bg-blue-500/20 text-blue-300 border border-blue-500/30 w-fit font-semibold">Phase 3 — React & Frontend Deep Dive (4-6 weeks)</div>
                <div className="text-slate-600">↓</div>
                ...
                <div className="text-slate-600">↓</div>
                <div className="px-4 py-2 rounded-lg bg-purple-500/20 text-purple-300 border border-purple-500/30 w-fit font-semibold">Phase 5 — Frontend System Design (4-6 weeks)</div>
                <div className="text-slate-600">↓</div>
        ...
        <Heading2>Phase 1 — CS Fundamentals (4-6 weeks)</Heading2>
        <Paragraph>
            If your <Highlight>fundamentals are weak</Highlight>, this is the most important step.
            Don&apos;t jump to React or LeetCode — build the foundation first.
        </Paragraph>
        <div className="my-4 space-y-2">
            {[
                'CPU, RAM, Storage — basic data flow',
                'Binary, ASCII, Unicode — data representation',
                'OS basics — Process vs Thread, Memory management',
                'HTTP/HTTPS — request/response, status codes',
                'DNS, TCP/IP, WebSocket — browser-server communication',
                'REST vs GraphQL, CORS, JWT',
                'Git advanced — rebase, cherry-pick, conflict resolution',
            ].map(item => (
                <div key={item} className="flex items-center gap-3 p-2.5 rounded-lg bg-red-500/5 border border-red-500/10">
        ...
        <Callout type="tip">
            Best single resource: <Highlight>Harvard CS50</Highlight> (free on YouTube). Covers C, algorithms, memory, web.
        </Callout>

        <Heading2>Phase 2 — JavaScript Mastery (4-6 weeks)</Heading2>
        <Paragraph>
            JavaScript is the <Highlight>core language</Highlight> of Frontend. Big tech asks deep JS questions —
            not just syntax but <Highlight>internal mechanisms</Highlight>.
        </Paragraph>
        <Heading3>Core Concepts</Heading3>
        <div className="my-4 grid grid-cols-1 md:grid-cols-2 gap-2">
            {[
                ...
                <div key={item} className="flex items-center gap-2 p-2.5 rounded-lg bg-yellow-500/5 border border-yellow-500/10">
                    <span className="text-yellow-400 text-xs">▸</span>
                    <span className="text-slate-200 text-sm">{item}</span>
                </div>
            ))}
        </div>
        <Heading3>Implement from Scratch</Heading3>
        <div className="my-4 space-y-1.5">
            {['Array.map/filter/reduce', 'Function.bind/call/apply', 'Promise & Promise.all', 'Debounce & Throttle', 'Deep clone / Deep equal', 'Event Emitter', 'Curry function'].map(item => (
                <div key={item} className="flex items-center gap-3 p-2 rounded-lg bg-yellow-500/5 border border-yellow-500/10">
                    <span className="text-yellow-400 text-xs">💻</span>
                    <span className="text-slate-300 text-sm"><InlineCode>{item}</InlineCode></span>
                </div>
            ))}
        </div>
        <Callout type="warning">
            Big tech <Highlight>loves asking &quot;implement X from scratch&quot;</Highlight>. If you only use APIs without understanding internals, you&apos;ll fail.
        </Callout>

        <Heading2>Phase 3 — React & Frontend Deep Dive (4-6 weeks)</Heading2>
        <div className="my-4 grid grid-cols-1 md:grid-cols-2 gap-2">
            {[
                'Virtual DOM & Reconciliation',
                'Hooks deep dive',
                'Component patterns (HOC, Render Props)',
                ...
                <div key={item} className="flex items-center gap-2 p-2.5 rounded-lg bg-blue-500/5 border border-blue-500/10">
        ...
        <Heading2>Phase 4 — DSA / LeetCode (6-8 weeks)</Heading2>
        <Paragraph>
            The <Highlight>most feared</Highlight> part but also <Highlight>mandatory</Highlight> at big tech.
            Target: <Highlight>~150 problems</Highlight> (70% Medium, 20% Easy, 10% Hard).
            Use <strong>NeetCode 150</strong> or <strong>Grind 75</strong>.
        </Paragraph>
        <div className="my-4 grid grid-cols-1 md:grid-cols-2 gap-2">
            {['Two Pointers', 'Sliding Window', 'BFS / DFS', 'Binary Search', 'Dynamic Programming', 'Backtracking', 'Stack-based', 'Greedy'].map(p => (
                <div key={p} className="flex items-center gap-2 p-2.5 rounded-lg bg-green-500/5 border border-green-500/10">
        ...
        <Paragraph>
            Frontend system design focuses on UI architecture, data flow, performance, and scalable component design.
        </Paragraph>
        <div className="my-4 space-y-2">
            {[
                'Design a News Feed (infinite scroll, virtualization)',
                'Design Autocomplete (debounce, caching, a11y)',
                'Design a Chat App (WebSocket, offline support)',
                'Design Collaborative Editor (CRDT/OT)',
                'Design an Image Carousel (lazy loading, gestures)',
            ].map(item => (
                <div key={item} className="flex items-center gap-3 p-2.5 rounded-lg bg-purple-500/5 border border-purple-500/10">
        ...
        <Paragraph>
            Practice with real people on <strong>Pramp.com</strong> or <strong>interviewing.io</strong>. Prepare 5-7 STAR stories for behavioral questions.
        </Paragraph>
        <div className="my-4 grid grid-cols-2 md:grid-cols-4 gap-2">
            {[['S', 'Situation', 'blue'], ['T', 'Task', 'purple'], ['A', 'Action', 'green'], ['R', 'Result', 'yellow']].map(([letter, label, color]) => (
                <div key={letter} className={`rounded-xl bg-${color}-500/10 border border-${color}-500/20 p-3 text-center`}>
                    <div className={`text-${color}-400 font-bold text-lg`}>{letter}</div>
        ...
        <div className="my-6 space-y-3">
            <div className="flex items-start gap-3 p-3 rounded-lg bg-slate-800/40 border border-white/5">
                <span className="text-red-400 mt-0.5">1.</span>
                <span className="text-slate-300"><Highlight>CS Fundamentals</Highlight> — don&apos;t skip, this separates juniors from seniors</span>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-slate-800/40 border border-white/5">
                <span className="text-yellow-400 mt-0.5">2.</span>
                <span className="text-slate-300"><Highlight>Deep JS</Highlight> — understand mechanisms, not just syntax. Implement from scratch</span>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-slate-800/40 border border-white/5">
                <span className="text-blue-400 mt-0.5">3.</span>
            ...
            <div className="flex items-start gap-3 p-3 rounded-lg bg-slate-800/40 border border-white/5">
                <span className="text-purple-400 mt-0.5">5.</span>
                <span className="text-slate-300"><Highlight>System Design</Highlight> — FE architecture, not just diagrams</span>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-slate-800/40 border border-white/5">
                <span className="text-pink-400 mt-0.5">6.</span>
        ...
        <Callout type="tip">
            Remember: <Highlight>Consistency &gt; Intensity</Highlight>. 2-3 hours daily beats 10-hour weekend marathons.
