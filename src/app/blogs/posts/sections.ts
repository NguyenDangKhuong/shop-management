...
export const blogSections: Record<string, BlogSection[]> = {
    ...
    'hash-map-pattern': [
        ...
        { id: 'walkthrough-chi-tit', title: { vi: 'Two Sum Walkthrough', en: 'Two Sum Walkthrough' } },
        { id: 'edge-case-phn-t-ln-hn-target', title: { vi: 'Edge case: phần tử > target', en: 'Edge Case: Element > Target' } },
        { id: 'so-snh-brute-force-vs-hashmap', title: { vi: 'Brute Force vs HashMap', en: 'Brute Force vs HashMap' } },
        { id: 'typescript-du--l-g', title: { vi: 'TypeScript: dấu !', en: 'TypeScript: ! operator' } },
        ...
        { id: 'bi-4-valid-anagram-leetcode-242', title: { vi: 'Valid Anagram', en: 'Valid Anagram' } },
        { id: 'bi-5-ransom-note-leetcode-383', title: { vi: 'Ransom Note', en: 'Ransom Note' } },
        { id: 'bi-6-intersection-of-two-arrays-leetcode-349', title: { vi: 'Intersection of Arrays', en: 'Intersection of Arrays' } },
        { id: 'bi-7-top-k-frequent-elements-leetcode-347', title: { vi: 'Top K Frequent', en: 'Top K Frequent' } },
        { id: 'bi-8-longest-consecutive-sequence-leetcode-128', title: { vi: 'Longest Consecutive', en: 'Longest Consecutive' } },
        { id: 'bi-9-subarray-sum-equals-k-leetcode-560', title: { vi: 'Subarray Sum Equals K', en: 'Subarray Sum Equals K' } },
        { id: 'bi-10-valid-sudoku-leetcode-36', title: { vi: 'Valid Sudoku', en: 'Valid Sudoku' } },
    ],
