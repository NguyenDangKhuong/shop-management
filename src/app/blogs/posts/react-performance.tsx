        ...
        en: (
            <>
                <Paragraph>
                    ...
                    This article covers <Highlight>15+ optimization techniques</Highlight> from basic to advanced.
                </Paragraph>
                ...
                <Paragraph>
                    <InlineCode>React.memo</InlineCode> wraps a component and <Highlight>skips re-rendering</Highlight> when props haven&apos;t changed (shallow comparison). Use for expensive components only.
                </Paragraph>

                <Heading2>2. useMemo — Cache Expensive Computations</Heading2>
                <Paragraph>
                    <InlineCode>useMemo</InlineCode> caches computation results, only recalculating when dependencies change. Don&apos;t overuse — only for genuinely expensive operations.
                </Paragraph>

                <Heading2>3. useCallback — Stabilize Function References</Heading2>
                <Paragraph>
                    <InlineCode>useCallback</InlineCode> keeps the same function reference between renders. Must be combined with <InlineCode>React.memo</InlineCode> on child components to be effective.
                </Paragraph>

                <Heading2>4. Code Splitting</Heading2>
                <Paragraph>
                    Use <InlineCode>React.lazy</InlineCode> + <InlineCode>Suspense</InlineCode> to split code into smaller chunks loaded on demand. In Next.js, use <InlineCode>dynamic</InlineCode> import.
                </Paragraph>

                <Heading2>5. Lazy Loading Components</Heading2>
                <Paragraph>
                    Nested <InlineCode>Suspense</InlineCode> boundaries allow progressive loading with component-level skeleton screens.
                </Paragraph>

                <Heading2>6. Virtualization</Heading2>
                <Paragraph>
                    Use <InlineCode>@tanstack/react-virtual</InlineCode> to render only visible items in large lists. 10,000 items → ~20 DOM nodes.
                </Paragraph>

                <Heading2>7. Debounce &amp; Throttle</Heading2>
                <Paragraph>
                    <Highlight>Debounce</Highlight>: wait until user stops typing. <Highlight>Throttle</Highlight>: max once per N ms.
                    Essential for search inputs and scroll handlers.
                </Paragraph>

                <Heading2>8. useTransition &amp; useDeferredValue</Heading2>
                <Paragraph>
                    React 18 concurrent features. Mark state updates as non-urgent to keep UI responsive during heavy operations.
                </Paragraph>

                <Heading2>9. Image Optimization</Heading2>
                <Paragraph>
                    Use Next.js <InlineCode>Image</InlineCode> for automatic optimization, or implement lazy loading with <InlineCode>Intersection Observer</InlineCode>. Use modern formats (WebP/AVIF).
                </Paragraph>

                <Heading2>10. State Colocation</Heading2>
                <Paragraph>
                    Place state as close as possible to where it&apos;s used. This is the most powerful optimization — no libraries needed!
                </Paragraph>

                <Heading2>11. Proper Keys in Lists</Heading2>
                <Paragraph>
                    Use unique IDs as keys, never <InlineCode>index</InlineCode> for dynamic lists. Never use <InlineCode>Math.random()</InlineCode>.
                </Paragraph>

                <Heading2>12. Web Workers</Heading2>
                <Paragraph>
                    Offload heavy computations to a background thread. Keeps the main thread free for UI updates.
                </Paragraph>

                <Heading2>13. Bundle Analysis</Heading2>
                <Paragraph>
                    Use <InlineCode>@next/bundle-analyzer</InlineCode> to find heavy dependencies. Replace moment.js with dayjs, import lodash functions individually.
                </Paragraph>

                <Heading2>14. Avoid Creating Objects in Render</Heading2>
                <Paragraph>
                    Move constant objects outside components. Use <InlineCode>useMemo</InlineCode> for computed values.
                    Avoid inline objects and functions in JSX props.
                </Paragraph>

                <Heading2>15. React DevTools Profiler</Heading2>
                <Paragraph>
                    Use the Profiler to identify exactly which components render slowly and why.
                    Enable &quot;Highlight updates&quot; to visualize re-renders in real-time.
                </Paragraph>

                <Heading2>16. React Server Components</Heading2>
                <Paragraph>
                    Server Components send zero JavaScript to the client. Default in Next.js App Router.
                    Only add <InlineCode>&apos;use client&apos;</InlineCode> when you need interactivity.
                </Paragraph>

                <Callout type="tip">
                    Performance optimization is an ongoing process. Start with the biggest bottlenecks, measure, then iterate.
                </Callout>
            </>
        ),
    },
