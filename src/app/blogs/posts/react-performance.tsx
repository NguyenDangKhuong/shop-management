...
// - Custom hooks dùng state/effects`}</CodeBlock>
                ...
                <div className="my-6 space-y-3">
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        ...
                        <span className="text-text-primary">Đo performance trước bằng <InlineCode>React DevTools Profiler</InlineCode></span>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary">Đặt state ở vị trí thấp nhất có thể (colocate state)</span>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary"><InlineCode>React.memo</InlineCode> + <InlineCode>useCallback</InlineCode> cho expensive children</span>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary"><InlineCode>useMemo</InlineCode> cho expensive calculations</span>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary">Code splitting với <InlineCode>React.lazy</InlineCode> / <InlineCode>dynamic import</InlineCode></span>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary">Virtualize danh sách lớn ({'>'}100 items)</span>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary">Debounce search inputs, throttle scroll handlers</span>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary">Optimize images: lazy load, WebP/AVIF, responsive sizes</span>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary">Dùng unique keys (không dùng index) cho dynamic lists</span>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary">Analyze bundle size, loại bỏ thư viện nặng không cần thiết</span>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary">Ưu tiên Server Components cho content không interactive</span>
                    </div>
                </div>
...
// - Custom hooks using state/effects`}</CodeBlock>
                ...
                <div className="my-6 space-y-3">
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary">Measure performance first with <InlineCode>React DevTools Profiler</InlineCode></span>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary">Place state at the lowest possible level (colocate state)</span>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary"><InlineCode>React.memo</InlineCode> + <InlineCode>useCallback</InlineCode> for expensive children</span>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary"><InlineCode>useMemo</InlineCode> for expensive calculations</span>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary">Code splitting with <InlineCode>React.lazy</InlineCode> / <InlineCode>dynamic import</InlineCode></span>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary">Virtualize large lists ({'>'}100 items)</span>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary">Debounce search inputs, throttle scroll handlers</span>
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary">Use unique keys (not index) for dynamic lists</span>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary">Analyze bundle size, remove unnecessary heavy libraries</span>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                        <span className="text-green-400 mt-0.5">✅</span>
                        <span className="text-text-primary">Prefer Server Components for non-interactive content</span>
                    </div>
                </div>
