  ...
  return (
    <div className='max-w-xs m-auto mt-40'>
      <div
        ...
        <h1 className='text-[20px] font-bold mt-2 uppercase font-serif'>Yumy shop</h1>
          ...
          <tbody>
            {addMoreList.map((item, idx) => (
              <tr key={idx}>
                ...
                <td className='border border-black text-right text-[10px]'>1</td>
            ...
            <tr>
              <td className='border border-black border-t-4 text-left text-[10px]'>Tổng</td>
              <td className='border border-black border-t-4 text-right text-[10px]'>{totalCart}</td>
              <td colSpan={2} className='border border-black border-t-4 text-right text-[10px]'>
                {currencyFormat(totalPrice)}
              </td>
            </tr>
            {discountPrice > 0 && (
              <tr>
                <td className='border border-black text-left text-[10px]'>Giảm giá </td>
                <td colSpan={3} className='border border-black text-right text-[10px]'>
            ...
            {discountPrice > 0 && (
              <tr>
                <td className='border border-black text-left text-[10px]'>Tiền đã giảm</td>
                <td colSpan={3} className='border border-black text-right text-[10px]'>
            ...
            <tr>
              <td className='border border-black text-left text-[10px]'>Khách đưa</td>
              <td colSpan={3} className='border border-black text-right text-[10px]'>
            ...
            {exchange > 0 && (
              <tr>
                <td className='border border-black text-left text-[10px]'>Trả lại</td>
                <td colSpan={3} className='border border-black text-right text-[10px]'>
        ...
        <div className='text-center text-[10px]'>Xin cảm ơn và hẹn gặp lại!</div>
      </div>
    </div>
  )
}
